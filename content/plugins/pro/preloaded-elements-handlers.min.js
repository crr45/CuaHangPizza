        ...
        var s = elementorModules.frontend.handlers.Base.extend({
            ...
            fitImages() {
                var e = jQuery
                  ...
                  , n = this.getSettings();
                t.isMasonryEnabled() ? this.elements.$postsContainer.removeClass(n.classes.hasItemRatio) : (this.elements.$postsContainer.toggleClass(n.classes.hasItemRatio, !!s.match(/\d/)),
