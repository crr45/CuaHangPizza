var _wapf = function(o) {
    var e, t, u = "wapf-", c = "." + u, a = null, i = [], l = {
        ...
        selectedQuantity: function() {
            var e = parseInt(o("form :input.qty").val().toString());
            return isNaN(e) ? 1 : e
        },
        currentProductType: function() {
            return o(c + "product-totals").data("product-type")
        },
        currentProductPrice: function() {
            var e = l.selectedVariation();
            return "variable" == l.currentProductType() && e ? e.display_price : o(c + "product-totals").data("product-price")
        },
        ...
        formatNumber: function(e, t, a, r, n) {
            ...
            return u = n ? u.replace(/0+$/, "") : u,
            i + (o ? c.substr(0, o) + a : "") + c.substr(o).replace(/(\d{3})(?=\d)/g, "$1" + a) + (u ? r + u : "")
        },
        formatMoney: function(e, t) {
            return e < 0 && t.format.replace("%2$s", "-%2$s"),
            t.format.replace("%1$s", t.symbol).replace("%2$s", l.formatNumber(Math.abs(e), t.decimals || 0, t.thousand, t.decimal, t.trimzero))
        }
    }, d = {
        init: function(e) {
            o("[data-dependencies]").each(function(e, t) {
                var a = o(t);
                i[a.data("field-id")] = l.getFieldValue(a)
            }),
            e.on("keyup change", c + "input", function() {
                d.doLogic(!1)
            }),
            d.doLogic(!0)
        },
        ...
        validRule: function(e, t, a) {
            ...
            if (!r.length)
                return !1;
            if (r.closest(c + "field-container").hasClass(u + "hide"))
                return !1;
        ...
        init: function(e) {
            "product" === wapf_config.page_type && o("[data-wapf-price]").length && (e.on("keyup change", c + "input", function() {
                r.calculate()
            }),
        ...
        calculate: function() {
            var e = o(".variation_id");
            if (e.length) {
                var t = parseInt(e.val());
                if (isNaN(t) || 0 === t)
                    return
            }
            var a = window.wapf_config.display_options
              , r = l.currentProductPrice() * l.selectedQuantity()
              , n = this.calculateOptions()
              , i = "-total";
            o(c + "product" + i).html(l.formatMoney(r, a)),
            o(c + "options" + i).html(l.formatMoney(n, a)),
            o(c + "grand" + i).html(l.formatMoney(r + n, a)),
            o(c + "product" + i + "s").show()
        },
    ...
    s.init(),
    r.init(n),
    l.varsViaAjax() && o("[data-wapf-price]").length && jQuery(document).on("found_variation", function(e, t) {
        jQuery(document).trigger("wapf-ajax-variation", [t]),
        a = t,
        r.calculate()
    }),
    o(c + "checkboxes[data-is-required=1]").each(function(e, t) {
        function a() {
    ...
    o(c + "checkable input").on("change", function() {
        var e = o(this);
        e.is(":radio") && e.closest(c + "field-input").find(c + "checkable").removeClass(u + "checked"),
        o(this).closest(c + "checkable").toggleClass(u + "checked")
    })
};
!function(e) {
    _wapf(e)
