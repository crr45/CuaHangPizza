(self.webpackChunkelementorFrontend = self.webpackChunkelementorFrontend || []).push([[941], {
    ...
    169: (e, t, r) => {
        ...
        var n = r(4762)
          ...
          , b = e.exports = function(e, t, r) {
            ...
            r && r.getter && (t = "get " + t),
            r && r.setter && (t = "set " + t),
            (!o(e, "name") || c && e.name !== t) && (a ? g(e, "name", {
                value: t,
                configurable: !0
            }) : e.name = t),
            _ && r && o(r, "arity") && e.length !== r.arity && g(e, "length", {
                value: r.arity
            });
            try {
            ...
            var n = d(e);
            return o(n, "source") || (n.source = v(y, "string" == typeof t ? t : "")),
            e
        }
        ;
    ...
    555: (e, t, r) => {
        ...
        var i = function _interopRequireWildcard(e, t) {
            ...
            return function(e, t) {
                ...
                for (const t in e)
                    "default" !== t && {}.hasOwnProperty.call(e, t) && ((s = (i = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (s.get || s.set) ? i(o, t, s) : o[t] = e[t]);
                return o
            }(e, t)
        }(r(3827))
          , s = n(r(6349));
        ...
        class TopBarTracking extends s.default {
            ...
            static waitForTopBar() {
                ...
                if (e)
                    return void this.attachTopBarTracking(e);
                const t = this.addObserver(document.body, {
                    childList: !0,
                    subtree: !0
                }, () => {
                    const e = document.querySelector(o);
                    e && (this.attachTopBarTracking(e),
                    t.disconnect(),
                    clearTimeout(r))
                }
                )
    ...
    1506: (e, t, r) => {
        ...
        var n = r(2914)
          ...
          , g = Result.prototype;
        e.exports = function(e, t, r) {
            var f, m, v, _, y, b, w, S = r && r.that, E = !(!r || !r.AS_ENTRIES), k = !(!r || !r.IS_RECORD), T = !(!r || !r.IS_ITERATOR), C = !(!r || !r.INTERRUPTED), O = n(t, S), stop = function(e) {
                return f && p(f, "normal"),
                new Result(!0,e)
            }, callFn = function(e) {
                return E ? (s(e),
    ...
    1851: (e, t, r) => {
        "use strict";
        var n, i, s, o = r(8473), a = r(1483), c = r(1704), l = r(5290), u = r(3181), d = r(7914), p = r(1), h = r(9557), g = p("iterator"), f = !1;
        [].keys && ("next"in (s = [].keys()) ? (i = u(u(s))) !== Object.prototype && (n = i) : f = !0),
        !c(n) || o(function() {
            var e = {};
            return n[g].call(e) !== e
        }) ? n = {} : h && (n = l(n)),
    ...
    3827: (e, t, r) => {
        ...
        class WpDashboardTracking {
            ...
            static init() {
                this.initialized || (this.restoreOrCreateSession(),
                this.isEventsManagerAvailable() && (this.startSessionMonitoring(),
            ...
            static restoreOrCreateSession() {
                ...
                e ? (this.sessionStartTime = e.sessionStartTime,
                this.navItemsVisited = new Set(e.navItemsVisited),
                this.lastActivityTime = Date.now(),
                this.sessionEnded = !1) : (this.sessionStartTime = Date.now(),
                this.lastActivityTime = Date.now(),
                this.sessionEnded = !1,
            ...
            static attachNavigationListener() {
                const handleLinkClick = e => {
                    ...
                    if (t && t.href) {
                        if (this.isLinkOpeningInNewTab(t))
                            return;
    ...
    4483: (e, t, r) => {
        "use strict";
        var n, i, s, o = r(4644), a = r(5578), c = r(1704), l = r(9037), u = r(5755), d = r(1831), p = r(5409), h = r(1507), g = "Object already initialized", f = a.TypeError, m = a.WeakMap;
        if (o || d.state) {
    ...
    4543: (e, t, r) => {
        ...
        class ActionControlTracking extends o.default {
            static init() {
                s.DashboardUtils.isElementorPage() && (this.attachDelegatedHandlers(),
            ...
            static initializeLinkDataIds() {
                const initializeLinks = () => {
                    document.querySelectorAll("a[href]").forEach(e => {
                        if (this.isExcludedElement(e) || this.isNavigationLink(e) || e.hasAttribute("data-id"))
                            return;
                ...
                ;
                "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", initializeLinks) : initializeLinks()
            }
            static addTrackingAttributesToFilterButtons() {
                ...
                ;
                "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", addDataIdToListTableButtons) : addDataIdToListTableButtons()
            }
            ...
            static attachDelegatedHandlers() {
                ...
                this.addEventListenerTracked(document, "click", t => {
                    ...
                    if (n && !this.isExcludedElement(n))
                        return e.includes(n.id) ? void this.trackControl(n, i.CONTROL_TYPES.FILTER) : void this.trackControl(n, i.CONTROL_TYPES.BUTTON);
                    const s = r.closest("a");
            ...
            static isNavigationLink(e) {
                ...
                if (!t)
                    return !1;
                if (t.startsWith("#") && t.includes("tab"))
                    return !0;
                if (e.classList.contains("nav-tab"))
                    return !0;
            ...
            static extractControlIdentifier(e, t) {
                ...
                if (i.CONTROL_TYPES.LINK === t) {
                    ...
                    if (r)
                        return this.removeNonceFromUrl(r)
                }
            ...
            static removeNonceFromUrl(e) {
                try {
                    ...
                    return null !== r && /^[0-9]+$/.test(r) && t.searchParams.delete("post"),
    ...
    6349: (e, t, r) => {
        ...
        t.default = class BaseTracking {
            static ensureOwnArrays() {
                Object.prototype.hasOwnProperty.call(this, "observers") || (this.observers = []),
                Object.prototype.hasOwnProperty.call(this, "eventListeners") || (this.eventListeners = [])
            }
            static destroy() {
                this.ensureOwnArrays(),
                this.observers.forEach(e => e.disconnect()),
                this.observers = [],
                this.eventListeners.forEach( ({target: e, type: t, handler: r, options: n}) => {
    ...
    7011: (e, t, r) => {
        ...
        class PluginActions extends s.default {
            ...
            static getUserInput() {
                if (!this.selectedReason || !["found_a_better_plugin", "other"].includes(this.selectedReason))
                    return null;
            ...
            static destroy() {
                "undefined" != typeof jQuery && jQuery(document).off("wp-plugin-deleting"),
    ...
    7670: (e, t, r) => {
        ...
        class ScreenViewTracking extends o.default {
            ...
            static getScreenData() {
                ...
                let s = ""
                  , o = "";
                if (s = t || (r || this.getScreenIdFromBody()),
            ...
            static trackScreen(e, t=i.SCREEN_TYPES.TOP_LEVEL_PAGE) {
                const r = `${e}-${t}`;
                this.trackedScreens.has(r) || (this.trackedScreens.add(r),
                i.default.trackScreenViewed(e, t))
            }
        }
